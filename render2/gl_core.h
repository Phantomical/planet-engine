...
typedef unsigned int GLhandleARB;
		...
		/*GL_QUADS seen in ARB_tessellation_shader*/
		...
		/* Version: 4.0*/
		/*GL_ACTIVE_SUBROUTINES seen in ARB_shader_subroutine*/
		/*GL_ACTIVE_SUBROUTINE_MAX_LENGTH seen in ARB_shader_subroutine*/
		/*GL_ACTIVE_SUBROUTINE_UNIFORMS seen in ARB_shader_subroutine*/
		/*GL_ACTIVE_SUBROUTINE_UNIFORM_LOCATIONS seen in ARB_shader_subroutine*/
		/*GL_ACTIVE_SUBROUTINE_UNIFORM_MAX_LENGTH seen in ARB_shader_subroutine*/
		/*GL_COMPATIBLE_SUBROUTINES seen in ARB_shader_subroutine*/
		/*GL_DOUBLE_MAT2 seen in ARB_vertex_attrib_64bit*/
		/*GL_DOUBLE_MAT2x3 seen in ARB_vertex_attrib_64bit*/
		/*GL_DOUBLE_MAT2x4 seen in ARB_vertex_attrib_64bit*/
		/*GL_DOUBLE_MAT3 seen in ARB_vertex_attrib_64bit*/
		/*GL_DOUBLE_MAT3x2 seen in ARB_vertex_attrib_64bit*/
		/*GL_DOUBLE_MAT3x4 seen in ARB_vertex_attrib_64bit*/
		/*GL_DOUBLE_MAT4 seen in ARB_vertex_attrib_64bit*/
		/*GL_DOUBLE_MAT4x2 seen in ARB_vertex_attrib_64bit*/
		/*GL_DOUBLE_MAT4x3 seen in ARB_vertex_attrib_64bit*/
		/*GL_DOUBLE_VEC2 seen in ARB_vertex_attrib_64bit*/
		/*GL_DOUBLE_VEC3 seen in ARB_vertex_attrib_64bit*/
		/*GL_DOUBLE_VEC4 seen in ARB_vertex_attrib_64bit*/
		/*GL_DRAW_INDIRECT_BUFFER seen in ARB_draw_indirect*/
		/*GL_DRAW_INDIRECT_BUFFER_BINDING seen in ARB_draw_indirect*/
		/*GL_FRACTIONAL_EVEN seen in ARB_tessellation_shader*/
		/*GL_FRACTIONAL_ODD seen in ARB_tessellation_shader*/
		/*GL_FRAGMENT_INTERPOLATION_OFFSET_BITS seen in ARB_gpu_shader5*/
		/*GL_GEOMETRY_SHADER_INVOCATIONS seen in ARB_pipeline_statistics_query*/
		#define GL_INT_SAMPLER_CUBE_MAP_ARRAY    0x900E
		/*GL_ISOLINES seen in ARB_tessellation_shader*/
		/*GL_MAX_COMBINED_TESS_CONTROL_UNIFORM_COMPONENTS seen in ARB_tessellation_shader*/
		/*GL_MAX_COMBINED_TESS_EVALUATION_UNIFORM_COMPONENTS seen in ARB_tessellation_shader*/
		/*GL_MAX_FRAGMENT_INTERPOLATION_OFFSET seen in ARB_gpu_shader5*/
		/*GL_MAX_GEOMETRY_SHADER_INVOCATIONS seen in ARB_gpu_shader5*/
		/*GL_MAX_PATCH_VERTICES seen in ARB_tessellation_shader*/
		#define GL_MAX_PROGRAM_TEXTURE_GATHER_OFFSET 0x8E5F
		/*GL_MAX_SUBROUTINES seen in ARB_shader_subroutine*/
		/*GL_MAX_SUBROUTINE_UNIFORM_LOCATIONS seen in ARB_shader_subroutine*/
		/*GL_MAX_TESS_CONTROL_INPUT_COMPONENTS seen in ARB_tessellation_shader*/
		/*GL_MAX_TESS_CONTROL_OUTPUT_COMPONENTS seen in ARB_tessellation_shader*/
		/*GL_MAX_TESS_CONTROL_TEXTURE_IMAGE_UNITS seen in ARB_tessellation_shader*/
		/*GL_MAX_TESS_CONTROL_TOTAL_OUTPUT_COMPONENTS seen in ARB_tessellation_shader*/
		/*GL_MAX_TESS_CONTROL_UNIFORM_BLOCKS seen in ARB_tessellation_shader*/
		/*GL_MAX_TESS_CONTROL_UNIFORM_COMPONENTS seen in ARB_tessellation_shader*/
		/*GL_MAX_TESS_EVALUATION_INPUT_COMPONENTS seen in ARB_tessellation_shader*/
		/*GL_MAX_TESS_EVALUATION_OUTPUT_COMPONENTS seen in ARB_tessellation_shader*/
		/*GL_MAX_TESS_EVALUATION_TEXTURE_IMAGE_UNITS seen in ARB_tessellation_shader*/
		/*GL_MAX_TESS_EVALUATION_UNIFORM_BLOCKS seen in ARB_tessellation_shader*/
		/*GL_MAX_TESS_EVALUATION_UNIFORM_COMPONENTS seen in ARB_tessellation_shader*/
		/*GL_MAX_TESS_GEN_LEVEL seen in ARB_tessellation_shader*/
		/*GL_MAX_TESS_PATCH_COMPONENTS seen in ARB_tessellation_shader*/
		/*GL_MAX_TRANSFORM_FEEDBACK_BUFFERS seen in ARB_transform_feedback3*/
		/*GL_MAX_VERTEX_STREAMS seen in ARB_transform_feedback3*/
		/*GL_MIN_FRAGMENT_INTERPOLATION_OFFSET seen in ARB_gpu_shader5*/
		#define GL_MIN_PROGRAM_TEXTURE_GATHER_OFFSET 0x8E5E
		#define GL_MIN_SAMPLE_SHADING_VALUE      0x8C37
		/*GL_NUM_COMPATIBLE_SUBROUTINES seen in ARB_shader_subroutine*/
		/*GL_PATCHES seen in NV_gpu_shader5*/
		/*GL_PATCH_DEFAULT_INNER_LEVEL seen in ARB_tessellation_shader*/
		/*GL_PATCH_DEFAULT_OUTER_LEVEL seen in ARB_tessellation_shader*/
		/*GL_PATCH_VERTICES seen in ARB_tessellation_shader*/
		#define GL_PROXY_TEXTURE_CUBE_MAP_ARRAY  0x900B
		#define GL_SAMPLER_CUBE_MAP_ARRAY        0x900C
		#define GL_SAMPLER_CUBE_MAP_ARRAY_SHADOW 0x900D
		#define GL_SAMPLE_SHADING                0x8C36
		/*GL_TESS_CONTROL_OUTPUT_VERTICES seen in ARB_tessellation_shader*/
		/*GL_TESS_CONTROL_SHADER seen in ARB_tessellation_shader*/
		/*GL_TESS_EVALUATION_SHADER seen in ARB_tessellation_shader*/
		/*GL_TESS_GEN_MODE seen in ARB_tessellation_shader*/
		/*GL_TESS_GEN_POINT_MODE seen in ARB_tessellation_shader*/
		/*GL_TESS_GEN_SPACING seen in ARB_tessellation_shader*/
		/*GL_TESS_GEN_VERTEX_ORDER seen in ARB_tessellation_shader*/
		/*GL_TEXTURE_BINDING_CUBE_MAP_ARRAY seen in ARB_direct_state_access*/
		/*GL_TEXTURE_CUBE_MAP_ARRAY seen in ARB_internalformat_query2*/
		/*GL_TRANSFORM_FEEDBACK seen in ARB_transform_feedback2*/
		/*GL_TRANSFORM_FEEDBACK_BINDING seen in ARB_transform_feedback2*/
		/*GL_TRANSFORM_FEEDBACK_BUFFER_ACTIVE seen in ARB_transform_feedback2*/
		/*GL_TRANSFORM_FEEDBACK_BUFFER_PAUSED seen in ARB_transform_feedback2*/
		/*GL_UNIFORM_BLOCK_REFERENCED_BY_TESS_CONTROL_SHADER seen in ARB_tessellation_shader*/
		/*GL_UNIFORM_BLOCK_REFERENCED_BY_TESS_EVALUATION_SHADER seen in ARB_tessellation_shader*/
		...
		/* Version: 4.2*/
		/*GL_ACTIVE_ATOMIC_COUNTER_BUFFERS seen in ARB_shader_atomic_counters*/
		/*GL_ALL_BARRIER_BITS seen in ARB_shader_image_load_store*/
		/*GL_ATOMIC_COUNTER_BARRIER_BIT seen in ARB_shader_image_load_store*/
		/*GL_ATOMIC_COUNTER_BUFFER seen in ARB_shader_atomic_counters*/
		/*GL_ATOMIC_COUNTER_BUFFER_ACTIVE_ATOMIC_COUNTERS seen in ARB_shader_atomic_counters*/
		/*GL_ATOMIC_COUNTER_BUFFER_ACTIVE_ATOMIC_COUNTER_INDICES seen in ARB_shader_atomic_counters*/
		/*GL_ATOMIC_COUNTER_BUFFER_BINDING seen in ARB_shader_atomic_counters*/
		/*GL_ATOMIC_COUNTER_BUFFER_DATA_SIZE seen in ARB_shader_atomic_counters*/
		/*GL_ATOMIC_COUNTER_BUFFER_REFERENCED_BY_FRAGMENT_SHADER seen in ARB_shader_atomic_counters*/
		/*GL_ATOMIC_COUNTER_BUFFER_REFERENCED_BY_GEOMETRY_SHADER seen in ARB_shader_atomic_counters*/
		/*GL_ATOMIC_COUNTER_BUFFER_REFERENCED_BY_TESS_CONTROL_SHADER seen in ARB_shader_atomic_counters*/
		/*GL_ATOMIC_COUNTER_BUFFER_REFERENCED_BY_TESS_EVALUATION_SHADER seen in ARB_shader_atomic_counters*/
		/*GL_ATOMIC_COUNTER_BUFFER_REFERENCED_BY_VERTEX_SHADER seen in ARB_shader_atomic_counters*/
		/*GL_ATOMIC_COUNTER_BUFFER_SIZE seen in ARB_shader_atomic_counters*/
		/*GL_ATOMIC_COUNTER_BUFFER_START seen in ARB_shader_atomic_counters*/
		/*GL_BUFFER_UPDATE_BARRIER_BIT seen in ARB_shader_image_load_store*/
		/*GL_COMMAND_BARRIER_BIT seen in ARB_shader_image_load_store*/
		...
		/*GL_ELEMENT_ARRAY_BARRIER_BIT seen in ARB_shader_image_load_store*/
		/*GL_FRAMEBUFFER_BARRIER_BIT seen in ARB_shader_image_load_store*/
		/*GL_IMAGE_1D seen in ARB_shader_image_load_store*/
		/*GL_IMAGE_1D_ARRAY seen in ARB_shader_image_load_store*/
		/*GL_IMAGE_2D seen in ARB_shader_image_load_store*/
		/*GL_IMAGE_2D_ARRAY seen in ARB_shader_image_load_store*/
		/*GL_IMAGE_2D_MULTISAMPLE seen in ARB_shader_image_load_store*/
		/*GL_IMAGE_2D_MULTISAMPLE_ARRAY seen in ARB_shader_image_load_store*/
		/*GL_IMAGE_2D_RECT seen in ARB_shader_image_load_store*/
		/*GL_IMAGE_3D seen in ARB_shader_image_load_store*/
		/*GL_IMAGE_BINDING_ACCESS seen in ARB_shader_image_load_store*/
		/*GL_IMAGE_BINDING_FORMAT seen in ARB_shader_image_load_store*/
		/*GL_IMAGE_BINDING_LAYER seen in ARB_shader_image_load_store*/
		/*GL_IMAGE_BINDING_LAYERED seen in ARB_shader_image_load_store*/
		/*GL_IMAGE_BINDING_LEVEL seen in ARB_shader_image_load_store*/
		/*GL_IMAGE_BINDING_NAME seen in ARB_shader_image_load_store*/
		/*GL_IMAGE_BUFFER seen in ARB_shader_image_load_store*/
		/*GL_IMAGE_CUBE seen in ARB_shader_image_load_store*/
		/*GL_IMAGE_CUBE_MAP_ARRAY seen in ARB_shader_image_load_store*/
		/*GL_IMAGE_FORMAT_COMPATIBILITY_BY_CLASS seen in ARB_shader_image_load_store*/
		/*GL_IMAGE_FORMAT_COMPATIBILITY_BY_SIZE seen in ARB_shader_image_load_store*/
		/*GL_IMAGE_FORMAT_COMPATIBILITY_TYPE seen in ARB_shader_image_load_store*/
		/*GL_INT_IMAGE_1D seen in ARB_shader_image_load_store*/
		/*GL_INT_IMAGE_1D_ARRAY seen in ARB_shader_image_load_store*/
		/*GL_INT_IMAGE_2D seen in ARB_shader_image_load_store*/
		/*GL_INT_IMAGE_2D_ARRAY seen in ARB_shader_image_load_store*/
		/*GL_INT_IMAGE_2D_MULTISAMPLE seen in ARB_shader_image_load_store*/
		/*GL_INT_IMAGE_2D_MULTISAMPLE_ARRAY seen in ARB_shader_image_load_store*/
		/*GL_INT_IMAGE_2D_RECT seen in ARB_shader_image_load_store*/
		/*GL_INT_IMAGE_3D seen in ARB_shader_image_load_store*/
		/*GL_INT_IMAGE_BUFFER seen in ARB_shader_image_load_store*/
		/*GL_INT_IMAGE_CUBE seen in ARB_shader_image_load_store*/
		/*GL_INT_IMAGE_CUBE_MAP_ARRAY seen in ARB_shader_image_load_store*/
		/*GL_MAX_ATOMIC_COUNTER_BUFFER_BINDINGS seen in ARB_shader_atomic_counters*/
		/*GL_MAX_ATOMIC_COUNTER_BUFFER_SIZE seen in ARB_shader_atomic_counters*/
		/*GL_MAX_COMBINED_ATOMIC_COUNTERS seen in ARB_shader_atomic_counters*/
		/*GL_MAX_COMBINED_ATOMIC_COUNTER_BUFFERS seen in ARB_shader_atomic_counters*/
		/*GL_MAX_COMBINED_IMAGE_UNIFORMS seen in ARB_shader_image_load_store*/
		/*GL_MAX_COMBINED_IMAGE_UNITS_AND_FRAGMENT_OUTPUTS seen in ARB_shader_storage_buffer_object*/
		/*GL_MAX_FRAGMENT_ATOMIC_COUNTERS seen in ARB_shader_atomic_counters*/
		/*GL_MAX_FRAGMENT_ATOMIC_COUNTER_BUFFERS seen in ARB_shader_atomic_counters*/
		/*GL_MAX_FRAGMENT_IMAGE_UNIFORMS seen in ARB_shader_image_load_store*/
		/*GL_MAX_GEOMETRY_ATOMIC_COUNTERS seen in ARB_shader_atomic_counters*/
		/*GL_MAX_GEOMETRY_ATOMIC_COUNTER_BUFFERS seen in ARB_shader_atomic_counters*/
		/*GL_MAX_GEOMETRY_IMAGE_UNIFORMS seen in ARB_shader_image_load_store*/
		/*GL_MAX_IMAGE_SAMPLES seen in ARB_shader_image_load_store*/
		/*GL_MAX_IMAGE_UNITS seen in ARB_shader_image_load_store*/
		/*GL_MAX_TESS_CONTROL_ATOMIC_COUNTERS seen in ARB_shader_atomic_counters*/
		/*GL_MAX_TESS_CONTROL_ATOMIC_COUNTER_BUFFERS seen in ARB_shader_atomic_counters*/
		/*GL_MAX_TESS_CONTROL_IMAGE_UNIFORMS seen in ARB_shader_image_load_store*/
		/*GL_MAX_TESS_EVALUATION_ATOMIC_COUNTERS seen in ARB_shader_atomic_counters*/
		/*GL_MAX_TESS_EVALUATION_ATOMIC_COUNTER_BUFFERS seen in ARB_shader_atomic_counters*/
		/*GL_MAX_TESS_EVALUATION_IMAGE_UNIFORMS seen in ARB_shader_image_load_store*/
		/*GL_MAX_VERTEX_ATOMIC_COUNTERS seen in ARB_shader_atomic_counters*/
		/*GL_MAX_VERTEX_ATOMIC_COUNTER_BUFFERS seen in ARB_shader_atomic_counters*/
		/*GL_MAX_VERTEX_IMAGE_UNIFORMS seen in ARB_shader_image_load_store*/
		...
		/*GL_PIXEL_BUFFER_BARRIER_BIT seen in ARB_shader_image_load_store*/
		/*GL_SHADER_IMAGE_ACCESS_BARRIER_BIT seen in ARB_shader_image_load_store*/
		/*GL_TEXTURE_FETCH_BARRIER_BIT seen in ARB_shader_image_load_store*/
		/*GL_TEXTURE_IMMUTABLE_FORMAT seen in ARB_texture_storage*/
		/*GL_TEXTURE_UPDATE_BARRIER_BIT seen in ARB_shader_image_load_store*/
		#define GL_TRANSFORM_FEEDBACK_ACTIVE     0x8E24
		/*GL_TRANSFORM_FEEDBACK_BARRIER_BIT seen in ARB_shader_image_load_store*/
		#define GL_TRANSFORM_FEEDBACK_PAUSED     0x8E23
		/*GL_UNIFORM_ATOMIC_COUNTER_BUFFER_INDEX seen in ARB_shader_atomic_counters*/
		/*GL_UNIFORM_BARRIER_BIT seen in ARB_shader_image_load_store*/
		...
		/*GL_UNSIGNED_INT_ATOMIC_COUNTER seen in ARB_shader_atomic_counters*/
		/*GL_UNSIGNED_INT_IMAGE_1D seen in ARB_shader_image_load_store*/
		/*GL_UNSIGNED_INT_IMAGE_1D_ARRAY seen in ARB_shader_image_load_store*/
		/*GL_UNSIGNED_INT_IMAGE_2D seen in ARB_shader_image_load_store*/
		/*GL_UNSIGNED_INT_IMAGE_2D_ARRAY seen in ARB_shader_image_load_store*/
		/*GL_UNSIGNED_INT_IMAGE_2D_MULTISAMPLE seen in ARB_shader_image_load_store*/
		/*GL_UNSIGNED_INT_IMAGE_2D_MULTISAMPLE_ARRAY seen in ARB_shader_image_load_store*/
		/*GL_UNSIGNED_INT_IMAGE_2D_RECT seen in ARB_shader_image_load_store*/
		/*GL_UNSIGNED_INT_IMAGE_3D seen in ARB_shader_image_load_store*/
		/*GL_UNSIGNED_INT_IMAGE_BUFFER seen in ARB_shader_image_load_store*/
		/*GL_UNSIGNED_INT_IMAGE_CUBE seen in ARB_shader_image_load_store*/
		/*GL_UNSIGNED_INT_IMAGE_CUBE_MAP_ARRAY seen in ARB_shader_image_load_store*/
		/*GL_VERTEX_ATTRIB_ARRAY_BARRIER_BIT seen in ARB_shader_image_load_store*/
		...
		/*GL_ATOMIC_COUNTER_BUFFER_REFERENCED_BY_COMPUTE_SHADER seen in ARB_compute_shader*/
		...
		/*GL_COMPUTE_SHADER seen in ARB_compute_shader*/
		/*GL_COMPUTE_SHADER_BIT seen in ARB_compute_shader*/
		...
		/*GL_COMPUTE_WORK_GROUP_SIZE seen in ARB_compute_shader*/
		...
		/*GL_DISPATCH_INDIRECT_BUFFER seen in ARB_compute_shader*/
		/*GL_DISPATCH_INDIRECT_BUFFER_BINDING seen in ARB_compute_shader*/
		...
		/*GL_MAX_COMBINED_COMPUTE_UNIFORM_COMPONENTS seen in ARB_compute_shader*/
		/*GL_MAX_COMBINED_DIMENSIONS seen in ARB_internalformat_query2*/
		/*GL_MAX_COMBINED_SHADER_OUTPUT_RESOURCES seen in ARB_shader_storage_buffer_object*/
		/*GL_MAX_COMBINED_SHADER_STORAGE_BLOCKS seen in ARB_shader_storage_buffer_object*/
		/*GL_MAX_COMPUTE_ATOMIC_COUNTERS seen in ARB_compute_shader*/
		/*GL_MAX_COMPUTE_ATOMIC_COUNTER_BUFFERS seen in ARB_compute_shader*/
		/*GL_MAX_COMPUTE_IMAGE_UNIFORMS seen in ARB_compute_shader*/
		/*GL_MAX_COMPUTE_SHADER_STORAGE_BLOCKS seen in ARB_shader_storage_buffer_object*/
		/*GL_MAX_COMPUTE_SHARED_MEMORY_SIZE seen in ARB_compute_shader*/
		/*GL_MAX_COMPUTE_TEXTURE_IMAGE_UNITS seen in ARB_compute_shader*/
		/*GL_MAX_COMPUTE_UNIFORM_BLOCKS seen in ARB_compute_shader*/
		/*GL_MAX_COMPUTE_UNIFORM_COMPONENTS seen in ARB_compute_shader*/
		/*GL_MAX_COMPUTE_WORK_GROUP_COUNT seen in ARB_compute_shader*/
		/*GL_MAX_COMPUTE_WORK_GROUP_INVOCATIONS seen in ARB_compute_shader*/
		/*GL_MAX_COMPUTE_WORK_GROUP_SIZE seen in ARB_compute_shader*/
		...
		/*GL_MAX_FRAGMENT_SHADER_STORAGE_BLOCKS seen in ARB_shader_storage_buffer_object*/
		...
		/*GL_MAX_GEOMETRY_SHADER_STORAGE_BLOCKS seen in ARB_shader_storage_buffer_object*/
		...
		/*GL_MAX_SHADER_STORAGE_BLOCK_SIZE seen in ARB_shader_storage_buffer_object*/
		/*GL_MAX_SHADER_STORAGE_BUFFER_BINDINGS seen in ARB_shader_storage_buffer_object*/
		/*GL_MAX_TESS_CONTROL_SHADER_STORAGE_BLOCKS seen in ARB_shader_storage_buffer_object*/
		/*GL_MAX_TESS_EVALUATION_SHADER_STORAGE_BLOCKS seen in ARB_shader_storage_buffer_object*/
		...
		/*GL_MAX_VERTEX_SHADER_STORAGE_BLOCKS seen in ARB_shader_storage_buffer_object*/
		...
		/*GL_SHADER_STORAGE_BARRIER_BIT seen in ARB_shader_storage_buffer_object*/
		/*GL_SHADER_STORAGE_BLOCK seen in ARB_program_interface_query*/
		/*GL_SHADER_STORAGE_BUFFER seen in ARB_shader_storage_buffer_object*/
		/*GL_SHADER_STORAGE_BUFFER_BINDING seen in ARB_shader_storage_buffer_object*/
		/*GL_SHADER_STORAGE_BUFFER_OFFSET_ALIGNMENT seen in ARB_shader_storage_buffer_object*/
		/*GL_SHADER_STORAGE_BUFFER_SIZE seen in ARB_shader_storage_buffer_object*/
		/*GL_SHADER_STORAGE_BUFFER_START seen in ARB_shader_storage_buffer_object*/
		...
		/*GL_UNIFORM_BLOCK_REFERENCED_BY_COMPUTE_SHADER seen in ARB_compute_shader*/
		...
		/* Version: 4.4*/
		/*GL_BUFFER_IMMUTABLE_STORAGE seen in ARB_buffer_storage*/
		/*GL_BUFFER_STORAGE_FLAGS seen in ARB_buffer_storage*/
		/*GL_CLEAR_TEXTURE seen in ARB_clear_texture*/
		/*GL_CLIENT_MAPPED_BUFFER_BARRIER_BIT seen in ARB_buffer_storage*/
		/*GL_CLIENT_STORAGE_BIT seen in ARB_buffer_storage*/
		/*GL_DYNAMIC_STORAGE_BIT seen in ARB_buffer_storage*/
		/*GL_LOCATION_COMPONENT seen in ARB_enhanced_layouts*/
		/*GL_MAP_COHERENT_BIT seen in ARB_buffer_storage*/
		/*GL_MAP_PERSISTENT_BIT seen in ARB_buffer_storage*/
		#define GL_MAX_VERTEX_ATTRIB_STRIDE      0x82E5
		/*GL_MIRROR_CLAMP_TO_EDGE seen in ARB_texture_mirror_clamp_to_edge*/
		#define GL_PRIMITIVE_RESTART_FOR_PATCHES_SUPPORTED 0x8221
		/*GL_QUERY_BUFFER seen in ARB_query_buffer_object*/
		/*GL_QUERY_BUFFER_BARRIER_BIT seen in ARB_query_buffer_object*/
		/*GL_QUERY_BUFFER_BINDING seen in ARB_query_buffer_object*/
		/*GL_QUERY_RESULT_NO_WAIT seen in ARB_query_buffer_object*/
		#define GL_TEXTURE_BUFFER_BINDING        0x8C2A
		/*GL_TRANSFORM_FEEDBACK_BUFFER_INDEX seen in ARB_enhanced_layouts*/
		/*GL_TRANSFORM_FEEDBACK_BUFFER_STRIDE seen in ARB_enhanced_layouts*/
		
		/* Version: 4.5*/
		/*GL_CLIP_DEPTH_MODE seen in ARB_clip_control*/
		/*GL_CLIP_ORIGIN seen in ARB_clip_control*/
		#define GL_CONTEXT_FLAG_ROBUST_ACCESS_BIT 0x00000004
		/*GL_CONTEXT_LOST seen in KHR_robustness*/
		/*GL_CONTEXT_RELEASE_BEHAVIOR seen in KHR_context_flush_control*/
		/*GL_CONTEXT_RELEASE_BEHAVIOR_FLUSH seen in KHR_context_flush_control*/
		/*GL_GUILTY_CONTEXT_RESET seen in KHR_robustness*/
		/*GL_INNOCENT_CONTEXT_RESET seen in KHR_robustness*/
		/*GL_LOSE_CONTEXT_ON_RESET seen in KHR_robustness*/
		/*GL_MAX_COMBINED_CLIP_AND_CULL_DISTANCES seen in ARB_cull_distance*/
		/*GL_MAX_CULL_DISTANCES seen in ARB_cull_distance*/
		/*GL_NEGATIVE_ONE_TO_ONE seen in ARB_clip_control*/
		/*GL_NO_RESET_NOTIFICATION seen in KHR_robustness*/
		/*GL_QUERY_BY_REGION_NO_WAIT_INVERTED seen in ARB_conditional_render_inverted*/
		/*GL_QUERY_BY_REGION_WAIT_INVERTED seen in ARB_conditional_render_inverted*/
		/*GL_QUERY_NO_WAIT_INVERTED seen in ARB_conditional_render_inverted*/
		/*GL_QUERY_TARGET seen in ARB_direct_state_access*/
		/*GL_QUERY_WAIT_INVERTED seen in ARB_conditional_render_inverted*/
		/*GL_RESET_NOTIFICATION_STRATEGY seen in KHR_robustness*/
		/*GL_TEXTURE_TARGET seen in ARB_direct_state_access*/
		/*GL_UNKNOWN_CONTEXT_RESET seen in KHR_robustness*/
		/*GL_ZERO_TO_ONE seen in ARB_clip_control*/
